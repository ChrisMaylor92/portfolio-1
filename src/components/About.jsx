export const About = () => {
    return (
        <div name="about">
        {/* Mobile View */}
        <div  className="md:hidden w-full h-screen flex  text-gray-300 "> 
            ...
            <div className="h-60">
                ...
                <div className="max-w-[1600px] w-full grid grid-cols-3 gap-8 px-4">
                    <div className="pb-4 ">
                        <p className="text-2xl font-bold inline border-b-4 border-[#5fff3f]">About</p>
                    </div>
                    <div></div>
                </div>
        ...
        {/* Desktop View */}
        <div name="about" className="hidden w-full h-screen md:grid grid-cols-3 text-gray-300 "> 
